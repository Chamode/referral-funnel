...
class Referral_Funnel_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $referral_funnel       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->referral_funnel, plugin_dir_url( __FILE__ ) . 'css/referral-funnel-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->referral_funnel, plugin_dir_url( __FILE__ ) . 'js/referral-funnel-admin.js', array( 'jquery' ), $this->version, false );
